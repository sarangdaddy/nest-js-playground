    ...
    <div className="px-4 py-16">
      ...
      <div className="my-5">
        ...
        <div className="relative flex items-center rounded-md shadow-sm">
          ...
          <input
            className="w-full appearance-none rounded-md border-gray-300 py-2 pl-7 placeholder-gray-400 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-500"
            id="price"
            type="text"
            placeholder="0.00"
          />
